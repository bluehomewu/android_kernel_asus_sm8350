...
struct sx93XX 
{
	...
	* or does not work properly */
	...
	struct delayed_work dworker1; /* work struct for worker function */
	struct delayed_work dworker2; /* work struct for worker function */
	struct delayed_work initworker1; /* ASUS_BSP initial work struct for worker function */
	struct delayed_work initworker2; /* ASUS_BSP initial work struct for worker function */
