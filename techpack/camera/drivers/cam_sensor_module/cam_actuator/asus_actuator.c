...
#endif
#if defined(ASUS_PICASSO_PROJECT) || defined(CONFIG_ASUS_PICASSO_QTI_EMBEDDED)
...
//		g_slave_id = val[3];//slave id
    ...
    #if defined(CONFIG_MACH_ASUS) || defined(CONFIG_ASUS_PICASSO_QTI_EMBEDDED)
